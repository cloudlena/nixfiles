    ...
    settings = {
      ...
      bind = [
        ...
        }
        {
          _args = [
            "SUPER + W"
            (lib.generators.mkLuaInline "hl.dsp.exec_cmd(\"${pkgs.brave-origin}/bin/brave-origin\")")
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "SUPER + SHIFT + S"
            (lib.generators.mkLuaInline "hl.dsp.window.move({ workspace = \"special\", follow = false })")
          ];
        }
        {
          _args = [
